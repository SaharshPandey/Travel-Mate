...
public class MyTripInfoActivity extends AppCompatActivity implements TravelmateSnackbars {
    ...
    public ArrayList<String> ids, emails;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<String> dataAdapter =
                new ArrayAdapter<>(getApplicationContext(), R.layout.spinner_layout, emails);
        dataAdapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        friendEmail.setAdapter(dataAdapter);
        //friendEmail.setOnItemClickListener((arg0, arg1, arg2, arg3) -> mFriendId = emails.get(arg2));
    ...
    void onClick() {
        ...
        /*BottomFriendFragment bottomSheetDialog = BottomFriendFragment.getInstance("");
